...
// Symbol Rate: 40.00092 kBaud
// Sync Word Length: 8 Bits
// TX Power: 0 dBm (requires define CCFG_FORCE_VDDR_HH = 1 in ccfg.c, see CC13xx/CC26xx Technical Reference Manual)
